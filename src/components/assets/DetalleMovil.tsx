...
import {
    ...
    Pencil, Battery, Globe, HardDrive, Phone, User,
} from "lucide-react";
    ...
    return (
        <div className="flex flex-col gap-6">
            ...
            <div className="grid grid-cols-3 gap-5">
                ...
                <div className="rounded-xl p-5 flex items-center gap-3 border border-gray-100 bg-white">
                    <Battery size={24} className="text-[#519d99]" />
                    <div>
