...
export default function DetalleLaptop({ raw, codigo, refetch }: Props) {
        ...
        <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col">
                <div className="flex gap-1 px-1">
                    <button
                        onClick={() => setTab("info")}
                        className={`px-5 py-3 text-md font-semibold rounded-t-xl border border-b-0 transition-all ${tab === "info"
                    ...
                    <button
                        ...
                        className={`px-5 py-3 text-md font-semibold rounded-t-xl border border-b-0 transition-all ${tab === "historial"
                            ? "bg-[#f8f9fb] text-[#519d99] border-gray-100 shadow-[0_-4px_10px_rgba(0,0,0,0.05)] z-10"
                            : "bg-gray-100 text-[#9898a0] border-transparent mt-2 hover:bg-gray-200/70 hover:text-[#686971]"
                            }`}
                    >
